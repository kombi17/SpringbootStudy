...
public class MemberController {
	 ...
	 */
	@PostMapping("/signUp")
	public String signUp(Member member, String[] userAddress, String[] userHobby, RedirectAttributes ra) {
...
//    		error, exception을 모델에 담아 view로 
	 ...
	 */
	@GetMapping("/list")
	public String selectAllUser(@RequestParam(value = "cp", required = false, defaultValue = "1") int cp, Model model,
	...
	public String userDetailForm(@PathVariable("userNo") int userNo,
			@RequestParam(value = "cp", required = false, defaultValue = "1") int cp, Principal principal, Model model,
	...
	public String userUpdate(String[] updateUserAddress, String[] updateUserHobby, Principal principal,
