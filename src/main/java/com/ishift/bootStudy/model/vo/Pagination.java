...
public class Pagination {
  ...
  // 제일 큰 페이지 번호 (마지막 페이지 번호)
  private int maxPage;
  // 목록 하단에 노출된 페이지의 시작 번호
  private int startPage;
  // 목록 하단에 노출된 페이지의 끝 번호
  private int endPage;

  // 목록 하단에 노출된 번호의 이전 목록 끝 번호
  private int prevPage;
  // 목록 하단에 노출된 번호의 다음 목록 시작 번호
  ...
  public String toString() {
    return "Pagination [currentPage=" + currentPage + ", listCount=" + listCount + ", limit="
        + limit + ", pageSize=" + pageSize + ", maxPage=" + maxPage + ", startPage=" + startPage
